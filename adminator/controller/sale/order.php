...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'date_added'    => date($this->language->get('date_format_short'), strtotime($result['date_added'])) . ' ' . date( 'H:i:s', strtotime($result['date_added']) ),
	...
	public function info() {
		...
		if ($order_info) {
            ...
            $data['emailpayment'] = $this->url->link('sale/order/emailpayment', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . (int)$this->request->get['order_id'], true);
			...
			$data['date_added'] = date($this->language->get('date_format_short'), strtotime($order_info['date_added']))
			                    .' - '. date( 'H:i:s A', strtotime($order_info['date_added']) );;
    ...
    {    
		...
		$data['paynow'] = 'https://littlethingsme.com/pay?order_id=' . $order_id . '&user_token=' . $this->session->data['user_token'];
        //email
        $this->load->model('setting/setting');
		...
		$mail->setHtml($this->load->view('sale/order_emailpayment', $data));
		$mail->send();
		...
		$mail->send();
		//remaining
		$this->response->setOutput($this->load->view('sale/order_emailpayment', $data));
	}
