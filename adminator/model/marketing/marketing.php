...
class ModelMarketingMarketing extends Model {
    ...
    public function getMarketingTable($id)
    {
        $order_statuses = $this->config->get('config_complete_status');
		foreach ($order_statuses as $order_status_id) {
			$implode[] = "o.order_status_id = '" . (int)$order_status_id . "'";
		}
        $sql = "SELECT * FROM `" . DB_PREFIX . "order` o WHERE (" . implode(" OR ", $implode) . ") AND o.marketing_id = " . $id;
	...
	public function getMarketings($data = array()) {
		...
		$implode[] = "o.order_status_id = '2'";
		$implode[] = "o.order_status_id = '3'";
