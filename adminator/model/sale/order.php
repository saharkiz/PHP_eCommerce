...
class ModelSaleOrder extends Model {
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.payment_method, o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o";
	...
	public function getSalePreorder($data = array()) {
		$sql = "SELECT  sum(o.total) as total FROM `" . DB_PREFIX . "order` o";
        $sql .= " WHERE o.order_status_id = '17'";
	...
	public function getSaleComplete($data = array()) {
		$sql = "SELECT  sum(o.total) as total FROM `" . DB_PREFIX . "order` o";
        $sql .= " WHERE o.order_status_id > '0'";
	...
	public function getSaleDateCount($data = array()) {
		$sql = "SELECT  count(o.total) as total FROM `" . DB_PREFIX . "order` o";
        $sql .= " WHERE o.order_status_id > '0'";
	...
	public function getDuplicateTotal() {
		$sql = "select GROUP_CONCAT(product_id) as id, sku, count(sku) as counter from " . DB_PREFIX . "product where length(sku)>1 GROUP BY sku HAVING COUNT(sku) > 1";
	...
	public function getDuplicate($data = array()) {
		$sql = "select GROUP_CONCAT(product_id) as id, sku, count(sku) as counter from " . DB_PREFIX . "product where length(sku)>1 GROUP BY sku HAVING COUNT(sku) > 1";
	...
	public function getTotalOrdersForMonth() {
		$sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order`";
        $sql .= " WHERE order_status_id = 5";
		$sql .= " AND DATE(date_added) >= DATE('" . date('Y-m-01') . "')";
