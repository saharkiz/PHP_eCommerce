		...
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			// Menu PreOrder
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/preproduct', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			...
			if ($forum) {
				$data['menus'][] = array(
					'id'       => 'menu-extension',
					'icon'	   => 'fa-forumbee', 
					'name'	   => $this->language->get('text_forum'),
					'href'     => '',
					'children' => $forum
				);		
			}
			...
			if ($this->user->hasPermission('access', 'auction/auction_duration')) {
				$auction[] = array(
					...
					'href'     => $this->url->link('auction/auction_duration', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'auction/bid_increments')) {
				$auction[] = array(
					...
					'href'     => $this->url->link('auction/bid_increments', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/auction')) {
				$auction[] = array(
					...
					'href'     => $this->url->link('catalog/auction', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access','eventmodule/event_module')) {
				$eventmodule[] = array(
					'name'	   => 'Event List',
					'href'     => $this->url->link('eventmodule/event_module','user_token=' . $this->session->data['user_token'], true),
					'children' => array()	
				);
			}
			...
			if ($eventmodule) {
				$data['menus'][] = array(
					'id'       => 'menu-eventmanagement',
					'icon'	   => 'fa-calendar', 
					'name'	   => 'Event Management',
					'href'     => '',
					'children' => $eventmodule
				);
			}
			// Sales
			$sale = array();
			...
			//Preorder 
			$sale[] = array(
					'name'	   => "Pre" . $this->language->get('text_order'),
					'href'     => $this->url->link('sale/preorder', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			$sale[] = array(
					'name'	   => "Sale Dates",
					'href'     => $this->url->link('sale/datesale', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			...
			if ($marketing) {
				$data['menus'][] = array(
					...
					'name'	   => $this->language->get('text_fml'),
					'href'     => $this->url->link('extension/module/filemanagerlite', 'user_token=' . $this->session->data['user_token'], true)
				);	
			}
			// System
			$system = array();
			...
			$report[] = array(
					'name'	   => 'Abandoned Cart',
					'href'     => $this->url->link('report/abandoned_carts', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
            ...
            $data['menus'][] = array(
				...
				'href'     => $this->url->link('payment/payment_form', 'user_token=' . $this->session->data['user_token'], true),
				'children' => array()
			);
